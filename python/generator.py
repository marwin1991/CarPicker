...
def get_cars():
    ...
    training_rows.append([50, 80, 70, 72, 80, 68, "VW Passat"])
    training_rows.append([40, 60, 60, 65, 58, 65, "VW Polo"])
    training_rows.append([45, 70, 65, 72, 70, 75, "VW Golf"])
    training_rows.append([55, 85, 75, 85, 80, 50, "VW Touareg"])
    training_rows.append([45, 65, 70, 77, 75, 45, "VW Tiguan"])
    training_rows.append([40, 50, 65, 70, 70, 45, "VW T-ROC"])

    training_rows.append([47, 84, 55, 70, 80, 67, "Skoda Superb"])
    training_rows.append([45, 78, 50, 70, 72, 71, "Skoda Octavia"])
    training_rows.append([40, 70, 40, 60, 58, 64, "Skoda Scala"])
    training_rows.append([50, 87, 68, 75, 77, 47, "Skoda Kodiaq"])
    training_rows.append([48, 75, 62, 70, 70, 42, "Skoda Karoq"])

    training_rows.append([57, 70, 75, 83, 74, 72, "Audi A4"])
    training_rows.append([58, 60, 78, 87, 74, 73, "Audi A5"])
    training_rows.append([60, 81, 78, 89, 80, 75, "Audi A6"])
    training_rows.append([61, 72, 79, 90, 80, 77, "Audi A7"])
    training_rows.append([61, 90, 85, 92, 91, 68, "Audi A8"])
    training_rows.append([60, 85, 83, 90, 90, 58, "Audi Q7"])
    training_rows.append([57, 75, 77, 81, 83, 60, "Audi Q5"])
    training_rows.append([53, 65, 73, 79, 80, 65, "Audi Q3"])

    training_rows.append([50, 54, 50, 47, 54, 48, "Opel Corsa"])
    training_rows.append([55, 60, 53, 59, 49, 47, "Opel Astra"])
    training_rows.append([60, 72, 62, 61, 62, 55, "Opel Insignia"])
    training_rows.append([55, 70, 58, 60, 62, 45, "Opel Crossland"])
    training_rows.append([65, 71, 63, 68, 65, 40, "Opel Grossland"])

    training_rows.append([45, 47, 40, 45, 50, 55, "Fiat 500"])
    training_rows.append([55, 58, 50, 50, 57, 47, "Fiat 500X"])
    training_rows.append([55, 72, 55, 51, 58, 45, "Fiat 500L"])
